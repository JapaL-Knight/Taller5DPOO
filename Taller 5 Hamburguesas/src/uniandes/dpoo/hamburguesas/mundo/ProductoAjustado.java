...
public class ProductoAjustado implements Producto
{
    ...
    public void addAgregados(Ingrediente ingrediente) throws IngredienteRepetidoException {
    	if(!this.agregados.contains(ingrediente)) {
    ...
    public void addEliminados(Ingrediente ingrediente) throws IngredienteRepetidoException {
    	if(!this.eliminados.contains(ingrediente)) {
    ...
    public int getPrecio( )
    {
    	...
    	for(Ingrediente ingrediente: agregados) {
    		suma += ingrediente.getCostoAdicional();
    	}
    	
        return productoBase.getPrecio() + suma;
    }
